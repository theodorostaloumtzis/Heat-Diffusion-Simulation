...
- \( nabla^2 \) είναι ο τελεστής Λαπλασιανού.

Αυτή η εξίσωση περιγράφει τον ρυθμό μεταβολής της θερμοκρασίας \( u \) ως προς τον χρόνο \( t \), εξαρτώμενη από τη θερμική διάχυση στο χώρο, περιγράφοντας τη μεταφορά θερμότητας μέσω αγωγής. H προσομοίωση χρησιμοποιεί τη μέθοδο πεπερασμένων διαφορών για την επίλυση αυτής της εξίσωσης σε ένα 2D πλέγμα.
